...
from ansible_collections.ansible.infoblox.tests.unit.compat import unittest
...
class TestNiosApi(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_connector = patch('ansible_collections.ansible.infoblox.plugins.module_utils.net_tools.nios.api.get_connector')
